                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="mt-3 mt-lg-0 col-lg-2 col-md-4">
                            ...
                            <ul className="list-unstyled ps-0 mb-0 mt-3">
                                ...
                                <li className="mt-2">
                                    <a className="text-light text-opacity-50" href="#">Email</a>
                                </li>
                                <li className="mt-2">
                                    <a className="text-light text-opacity-50" href="#">Social Feed</a>
                                </li>
                                <li className="mt-2">
                                    <a className="text-light text-opacity-50" href="#">Proyectos</a>
                                </li>
                                <li className="mt-2">
                        ...
                        <div className="mt-3 mt-lg-0 col-lg-2 col-md-4">
                            ...
                            <ul className="list-unstyled ps-0 mb-0 mt-3">
                                <li className="mt-2">
                                    <a className="text-light text-opacity-50" href="#">Centro de Ayuda</a>
                                </li>
                                <li className="mt-2">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="mt-5">
                                <p className="text-light text-opacity-50 mt-4 text-center mb-0">© 2018 - 2025 TiBACK. Diseño y codificación realizada por Elkin, Johan y Manuel</p>
                            </div>
                        </div>
                    </div>
                </div>
